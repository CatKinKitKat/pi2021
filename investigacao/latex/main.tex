...
\definecolor{estigred}{RGB}{100.0,0.0,22.0}
\usepackage[colorinlistoftodos]{todonotes}
\usepackage[colorlinks=true, allcolors=estigred]{hyperref}

\title{\includegraphics[scale=0.2]{estig_logo.png}\\[0.5cm]Sites de turismo e reservas} % Doc name
